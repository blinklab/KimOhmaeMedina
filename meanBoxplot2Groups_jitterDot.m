function meanBoxplot2Groups_jitterDot(group1, group2, lineColor, dotColor)
hold on
meanval = mean(group1);
...
scatter(ones(1,size(group1,1))+((rand(1,size(group1,1))-0.5)*0.25), group1, 4, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', dotColor)
...
scatter((ones(1,size(group1,1))*2)+((rand(1,size(group1,1))-0.5)*0.25), group2, 4, 'MarkerFaceColor', 'none', 'MarkerEdgeColor', dotColor)
end