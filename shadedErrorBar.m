%%%  Rob Campbell (2020). raacampbell/shadedErrorBar
%%%     (https://github.com/raacampbell/shadedErrorBar), GitHub. Retrieved February 2, 2019. 
%
% Note that this function was not written by the authors of Kim, Ohmae, &
% Medina (2019 initial submission, NN), but it is included in this
% repository so that all functions required to make the plots in the paper
% are available.
